...
//    	  $("#the-span").addEventListener("click", function() {
//    		  var json = JSON.stringify({
//    		    id: parseInt(this.dataset.value)
//    		  });
//    		});
//    	 console.log(json);
//    });
    ...
    $(document).ready(function() {
    	for (var i = 0; i < 5; i++) {
    		var thuoghieu = [$(".thuonghieu").val()];
		}
    	
    	console.log(thuoghieu);
		 filter_data();
		 ...
		 var formDoc = $.map($('.page','click'), function(e) {
...
//		 lsp:loaisanpham, th:thuonghieu, lm:loaimay,cn:congnghe},
		 success: function(products) {
			 ...
			 for (var i = 0; i < leng; i++) {
				...
				s += '<a href="addProduct/' + products[i].id +'" class="add-to-cart"><i class="flaticon-commerce"></i>Add To Cart</a>';
